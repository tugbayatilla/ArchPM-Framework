...
{
    [TestClass]
    public class CaseInsensitiveValueSectionSampleTests
    {
        [TestMethod]
        public void CaseInsensitiveValueSectionSample_WhenAllFieldsValidThenReturnValid()
        {
            var manager = ApiQuerySectionManager.Initialize("CaseInsensitiveValueSectionSample");
